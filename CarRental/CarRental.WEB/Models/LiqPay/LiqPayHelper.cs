...
namespace CarRental.WEB.Models.LiqPay
{
    public class LiqPayHelper
    {
        ...
        static LiqPayHelper()
        {
            _public_key = "sandbox_i81159437704";     // Public Key компанії, який можна знайти в особистому кабінеті на сайті liqpay.ua
            _private_key = "sandbox_27KoNHCkggonOUcf1yO4nV32H5We01whUH8qVqp5";    // Private Key компанії, який можна знайти в особистому кабінеті на сайті liqpay.ua
        }
